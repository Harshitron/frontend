...
export default function App() {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      ...
      try {
        setLoading(true)
        const res = await axios.get('https://new-backend-vwpp.onrender.com/api/v1/customers/all', {
          headers: {
        ...
        const resOrders = await axios.get('https://new-backend-vwpp.onrender.com/api/v1/orders/all', {
          headers: {
            Authorization: `Bearer ${token}`, // this hits the `protect` middleware
          },
        });
        ...
        const resCampaign = await axios.get('https://new-backend-vwpp.onrender.com/api/v1/campaignHistory/all?includeCustomers=true', {
          headers: {
            Authorization: `Bearer ${token}`, // this hits the `protect` middleware
          },
        });
  ...
  const handleLogin = async (credentialResponse) => {
    ...
    try {
      ...
      const res = await axios.post("https://new-backend-vwpp.onrender.com/api/v1/auth/google", { token })
